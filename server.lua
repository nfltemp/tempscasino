...
-- Register the pimpmenu command server-side
QBCore.Commands.Add('pimpmenu', 'Open the pimp main menu', {}, false, function(source)
    TriggerClientEvent('pimp:openMainMenu', source)
end)

-- Register the testcontext command server-side
QBCore.Commands.Add('testcontext', 'Open the test context menu', {}, false, function(source)
    TriggerClientEvent('pimp:openMainMenu', source)
end)

-- Add any other server-side logic here

-- Callback to check if player has enough money
...
-- Event handlers for winning/losing bets
...
-- Add these to your existing server.lua
