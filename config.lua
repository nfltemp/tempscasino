...
Config.AI = {
    ...
    SpawnInterval = 480000, -- 8 minutes in milliseconds
    SpawnChance = 75, -- 75% chance to spawn each interval
    CheckInterval = 1000, -- Check every second (reduced from 10000)
    BarRadius = 20.0, -- Radius in meters to consider "in the bar"
    Behaviors = {
